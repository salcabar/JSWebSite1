...
function showResult() {
    ...
    if (parseInt(resultScore) < 470) {
        ...
        shareContent = "我在超级大脑第三季中获得了" + resultScore + "分，你不服就来试试！";
    }
    else {
        //shareContent = "我在超级大脑第二季中获得了" + resultScore + "分，击败了100%的人，成为了超级大脑！";
        shareContent = "我在超级大脑第三季中获得了" + resultScore + "分，成为了超级大脑！";
    }

    $.ajax({
        type: "GET",
        async: true,
        url: "http://gameapi.luqinwenda.com/score.aspx?season=3&score=" + resultScore,
    ...
    window.shareData.imgUrl = "http://gameapi.luqinwenda.com/image/start3.jpg";
    window.shareData.timeLineLink = "http://gameapi.luqinwenda.com/season3/";
    window.shareData.sendFriendLink = "http://gameapi.luqinwenda.com/season3/";
    window.shareData.weiboLink = "http://gameapi.luqinwenda.com/season3/"
...
document.addEventListener('WeixinJSBridgeReady', function onBridgeReady() {
    window.shareData = {
        "imgUrl": "http://gameapi.luqinwenda.com/image/start3.jpg",
        "timeLineLink": "http://gameapi.luqinwenda.com/season3/",
        "sendFriendLink": "http://gameapi.luqinwenda.com/season3/",
        "weiboLink": "http://gameapi.luqinwenda.com/season3/",
        "tTitle": shareContent,
