...
function showResult() {
    ...
    if (parseInt(resultScore) < 470) {
        shareContent = "我在超级大脑第四季中获得了" + resultScore + "分，你不服就来试试！";
    }
    else {
        shareContent = "我在超级大脑第四季中获得了" + resultScore + "分，成为了超级大脑！";
    }

    $.ajax({
        type: "GET",
        async: true,
        url: "http://gameapi.luqinwenda.com/score.aspx?season=4&score=" + resultScore,
    ...
    window.shareData.imgUrl = "http://gameapi.luqinwenda.com/image/start4.jpg";
    window.shareData.timeLineLink = "http://gameapi.luqinwenda.com/season4/";
    window.shareData.sendFriendLink = "http://gameapi.luqinwenda.com/season4/";
    window.shareData.weiboLink = "http://gameapi.luqinwenda.com/season4/"
...
document.addEventListener('WeixinJSBridgeReady', function onBridgeReady() {
    window.shareData = {
        "imgUrl": "http://gameapi.luqinwenda.com/image/start4.jpg",
        "timeLineLink": "http://gameapi.luqinwenda.com/season4/",
        "sendFriendLink": "http://gameapi.luqinwenda.com/season4/",
        "weiboLink": "http://gameapi.luqinwenda.com/season4/",
        "tTitle": shareContent,
