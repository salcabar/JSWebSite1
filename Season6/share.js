...
function showResult() {
    ...
    if (parseInt(resultScore) < 470) {
        ...
        shareContent = "我在超级大脑第六季中获得了" + resultScore + "分，你不服就来试试！";
    }
    else {
        //shareContent = "我在超级大脑第二季中获得了" + resultScore + "分，击败了100%的人，成为了超级大脑！";
        shareContent = "我在超级大脑第六季中获得了" + resultScore + "分，成为了超级大脑！";
    }

    $.ajax({
        type: "GET",
        async: true,
        url: "http://gameapi.luqinwenda.com/score.aspx?season=6&score=" + resultScore,
    ...
    window.shareData.imgUrl = "http://gameapi.luqinwenda.com/image/start6.jpg";
    window.shareData.timeLineLink = "http://gameapi.luqinwenda.com/season6/";
    window.shareData.sendFriendLink = "http://gameapi.luqinwenda.com/season6/";
    window.shareData.weiboLink = "http://gameapi.luqinwenda.com/season6/"
...
document.addEventListener('WeixinJSBridgeReady', function onBridgeReady() {
    window.shareData = {
        "imgUrl": "http://gameapi.luqinwenda.com/image/start6.jpg",
        "timeLineLink": "http://gameapi.luqinwenda.com/season6/",
        "sendFriendLink": "http://gameapi.luqinwenda.com/season6/",
        "weiboLink": "http://gameapi.luqinwenda.com/season6/",
        "tTitle": shareContent,
