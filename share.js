...
function showResult() {
    ...
    if (parseInt(resultScore) < 470) {
        ...
        //shareContent = "我在超级大脑第一季中获得了" + resultScore + "分，击败了" + rate + "的人，你不服就来试试！";
        shareContent = "我在超级大脑第一季中获得了" + resultScore + "分，你不服就来试试！";
    }
    else {
        //shareContent = "我在超级大脑第一季中获得了" + resultScore + "分，击败了100%的人，成为了超级大脑！";
        shareContent = "我在超级大脑第一季中获得了" + resultScore + "分，成为了超级大脑！";
    }

    $.ajax({
        type: "GET",
        async: true,
        url: "http://gameapi.luqinwenda.com/score.aspx?score=" + resultScore,
    ...
    window.shareData.imgUrl = "http://gameapi.luqinwenda.com/image/start.jpg";
    window.shareData.timeLineLink = "http://gameapi.luqinwenda.com/";
    window.shareData.sendFriendLink = "http://gameapi.luqinwenda.com/";
    window.shareData.weiboLink = "http://gameapi.luqinwenda.com/"
...
document.addEventListener('WeixinJSBridgeReady', function onBridgeReady() {
    window.shareData = {
        "imgUrl": "http://gameapi.luqinwenda.com/image/start.jpg",
        "timeLineLink": "http://gameapi.luqinwenda.com/",
        "sendFriendLink": "http://gameapi.luqinwenda.com/",
        "weiboLink": "http://gameapi.luqinwenda.com/",
        "tTitle": shareContent,
